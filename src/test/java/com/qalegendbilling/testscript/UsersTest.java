...
public class UsersTest extends UsersBaseTest{
	...
	@Test(priority = 1, enabled = true, description = "TC010 verify Users Page Title",groups= {"Regression"})
	public void TC_010_verifyUsersPageTitle() {
		userPageTitle();
	}
	
	@Test(priority = 1, enabled = true, description = "TC011 verify User Search With Valid Data",groups= {"Regression"})
	public void TC_011_verifyUserSearchWithValidData(){
		userSearchWithValidData();
	}
	
	@Test(priority = 1, enabled = true, description = "TC012 verify Message Displayed By User Search With InvalidData",groups= {"Regression"})
	public void TC_012_verifyMessageDisplayedByUserSearchWithInvalidData() {
		messageDisplayedWithInvalidData();
	}
	
	@Test(priority = 1, enabled = true, description = "TC013 verify Error Message Displayed In Add User",groups= {"Regression"})
	public void TC_013_verifyErrorMessageDisplayedInAddUser() {
		errorMessageDisplayed();
	}
	
	@Test(priority = 1, enabled = true, description = "TC019 verify User Can Delete A User",groups= {"Regression"})
	public void TC_019_verifyUserCanDeleteAUser(){
		userCanDeleteUser();
	}
	
	@Test(priority = 1, enabled = true, description = "TC020 verify User Can View Use Details",groups= {"Regression"})
